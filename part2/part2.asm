...
debounce_500ms	ldx	#500			
again		pshx
		ldx	#1000
insideAgain	
		psha			; 2 E CYCLES
		pula			; 3 E CYCLES
		dbne	x,insideAgain	; 3 E CYCLES
		pulx
...
debounce	fcb nl,cr,"debouncer",nl,cr, $00
;killed		fcb nl,cr,"killed",nl,cr, $00
;saved		fcb nl,cr,"saved",nl,cr, $00
